######################################################################
#
#  Tree Responses to Regional Gradients -- calculating functional neighborhoods
#
...
# Functions for neighborhood effects and functional neighborhood for given trait 
